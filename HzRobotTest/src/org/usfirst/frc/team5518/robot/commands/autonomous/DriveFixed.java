...
public class DriveFixed extends Command {
	...
	private static double ULTRA_TOL_INCHES = 5.0;
	private static double DRIVE_SECONDS = 1500;
    ...
    protected void execute() {
    	//ultra = Robot.sensor.getUltraVals();
    ...
    protected boolean isFinished() {
    	...
    	// return (ultra[0] <= ULTRA_TOL_INCHES)
    	
        return ((System.currentTimeMillis() - time) >= DRIVE_SECONDS);
    }
